...
for fl=1:FL
    ...
    toc
    disp(fl);
    save('CIFAR_100_exact.mat','p_true','p_est_org','p_est_aux_grad','p_est_aux_W_grad','p_est_compare','p_est_compare_mod','p_est_soft_label','epochs','B','T_glob');
    
end
%%
ip_filename = 'CIFAR_100_exact.mat';
op_filename = 'CIFAR_100_exact';
