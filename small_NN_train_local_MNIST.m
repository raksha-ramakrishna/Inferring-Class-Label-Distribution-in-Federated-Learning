function [W_local,net] = small_NN_train_local_MNIST(XTrain_10,YTrain_10,epochs,B,W_G,flag_plot,s1,s2)
...
Ylabels = categorical(YTrain_10,{s1,s2});
...
net = trainNetwork(XTrain_10,Ylabels,layers,options);
 ...
 W_local = {net.Layers(2,1).Weights,net.Layers(2,1).Bias,net.Layers(6,1).Weights,net.Layers(6,1).Bias,...
   net.Layers(9,1).Weights,net.Layers(9,1).Bias};
